...
download.file(url = url_pr, destfile = "C:/Users/mandy.karnauskas/Downloads/test_pr.csv")
download.file(url = url_st, destfile = "C:/Users/mandy.karnauskas/Downloads/test_st.csv")
download.file(url = url_sj, destfile = "C:/Users/mandy.karnauskas/Downloads/test_sj.csv")
download.file(url = url_sc, destfile = "C:/Users/mandy.karnauskas/Downloads/test_sc.csv")

kdlabs <- read.table("C:/Users/mandy.karnauskas/Downloads/test_pr.csv", sep = ",", header = T, skip = 0)
kd_pr <- read.table("C:/Users/mandy.karnauskas/Downloads/test_pr.csv", sep = ",", header = T, skip = 1)
kd_st <- read.table("C:/Users/mandy.karnauskas/Downloads/test_st.csv", sep = ",", header = T, skip = 1)
kd_sj <- read.table("C:/Users/mandy.karnauskas/Downloads/test_sj.csv", sep = ",", header = T, skip = 1)
kd_sc <- read.table("C:/Users/mandy.karnauskas/Downloads/test_sc.csv", sep = ",", header = T, skip = 1)
...
# save and plot ---------------------------------------
inddata <- s
save(inddata, file = "C:/Users/mandy.karnauskas/Desktop/Caribbean-ESR/indicator_objects/turbidity.RData")

plotIndicatorTimeSeries(s, coltoplot = 1:4, dateformat = "%m-%Y", sublabel = T, trendAnalysis = T, widadj = 1.5)
