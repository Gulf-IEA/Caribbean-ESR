...
plot_and_save <- function(data_path, plot_params, save_path, width_inch = 8, height_inch = 5, dpi = 300) {
  tryCatch({
...
datasets <- list(
  ...
  list(data_path = "indicator_objects/DegreeHeatingWeeks.RData", 
       plot_params = list(coltoplot = 1:2, plotrownum = 2, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%Y%m", sublabel = TRUE), 
  ...
  list(data_path = "indicator_objects/OA.RData", 
       plot_params = list(coltoplot = 1, plotrownum = 1, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y", sublabel = F), 
  ...
  list(data_path = "indicator_objects/turbidity.RData", 
       plot_params = list(coltoplot = 1:3, plotrownum = 2, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%m-%Y", sublabel = TRUE), 
       save_path = "indicator_plots/turbidity_plot.png"),
  
  # 5. Sea surface temperature
  list(data_path = "indicator_objects/Carib_SST.RData", 
       plot_params = list(coltoplot = 1:3, plotrownum = 2, plotcolnum = 2, trendAnalysis = TRUE, dateformat = "%m-%Y", sublabel = TRUE), 
       save_path = "indicator_plots/Carib_SST_plot.png"),
  
  # 6. Marine debris
  list(data_path = "indicator_objects/marine_debris.RData", 
       plot_params = list(coltoplot = 1, plotrownum = 1, plotcolnum = 1, trendAnalysis = FALSE, dateformat = "%b%Y", sublabel = F), 
  ...
  list(data_path = "indicator_objects/pollution.RData", 
       plot_params = list(coltoplot = 1:2, plotrownum = 2, plotcolnum = 1, trendAnalysis = FALSE, dateformat = "%b%Y", sublabel = TRUE), 
  ...
  list(data_path = "indicator_objects/carib_Chl.RData", 
       plot_params = list(coltoplot = 1, plotrownum = 1, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%m-%Y", sublabel = F), 
  ...
  list(data_path = "indicator_objects/disturbance.RData", 
       plot_params = list(coltoplot = 1:3, plotrownum = 2, plotcolnum = 2, trendAnalysis = TRUE, dateformat = "%b%Y", sublabel = TRUE), 
  ...
  list(data_path = "indicator_objects/hotel_occupancy.RData", 
       plot_params = list(coltoplot = 1:2, plotrownum = 2, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%Y%b", sublabel = TRUE), 
       save_path = "indicator_plots/hotel_occupancy_plot.png"),
  
  # 14. Population change
  list(data_path = "indicator_objects/population.RData", 
       plot_params = list(coltoplot = 1:2, plotrownum = 2, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y", sublabel = TRUE), 
  ...
  list(data_path = "indicator_objects/RVC_PR.RData", 
       plot_params = list(coltoplot = 1:6, plotrownum = 3, plotcolnum = 2, trendAnalysis = TRUE, dateformat = "%b%Y", sublabel = TRUE), 
  ...
  # 16. Fish density / slope of size spectrum
  ...
  list(data_path = "indicator_objects/PR_Lmax_classes.RData", 
       plot_params = list(coltoplot = 1:5, plotrownum = 3, plotcolnum = 2, trendAnalysis = TRUE, dateformat = "%b%Y", sublabel = TRUE), 
  ...
  list(data_path = "indicator_objects/total_landings.RData", 
       plot_params = list(coltoplot = 1:9, plotrownum = 3, plotcolnum = 3, trendAnalysis = TRUE, dateformat = "%b%Y", sublabel = TRUE), 
  ...
  list(data_path = "indicator_objects/oceanNAICS.RData", 
       plot_params = list(coltoplot = 1:8, plotrownum = 4, plotcolnum = 2, trendAnalysis = TRUE, dateformat = "%b%Y", sublabel = TRUE), 
  ...
  list(data_path = "indicator_objects/outreach.RData", 
       plot_params = list(coltoplot = 1:2, plotrownum = 2, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y", sublabel = F), 
       save_path = "indicator_plots/outreach_plot.png"),
  
  # 31. coral
  list(data_path = "indicator_objects/coral_spprichness_cover.RData", 
       plot_params = list(coltoplot = 1:4, plotrownum = 2, plotcolnum = 2, trendAnalysis = TRUE, dateformat = "%b%Y", sublabel = TRUE), 
